---
lang: en
title: "Longitudinal observation of instrumental activities of daily living in Parkinson's disease patients"
shorttitle: "iADL long"
author:
  ...
  - name: Daniel Janko
    corresponding: false
    email: "daniel.janko@uni-potsdam.de "
    role:
      - Conceptualization
      - Investigation
      - Methodology
  ...
  - name: Filip Havlik
    corresponding: false
    orcid: "0000-0003-4442-6743"
    email: "filip.havlik.kv@gmail.com"
    role:
      - Investigation
    affiliations:
      - id: "1FM"
...
The neuropsychological assessment in pre-test-post-test followed the standard Movement Disorder Society neuropsychological batter at Level 1 for PD-MCI [@bezdicek2016; @bezdicek2017; @litvan2012] cognitive performance was assessed by Mattis Dementia Rating Scale, second edition (DRS-2) [@bezdicek2015; @jurica2001]. iADL and everyday functioning were measured by the PDAQ and FAQ self-reports. Lastly, depressive symptoms were assessed with the Beck Depression Scale (BDI-II) [@beck1996; @ciharova2020].
...
Based on previously published data, we calculated the two subscores - cognitive-driven (FAQc) and motor-drive (FAQm) [@becker2018a]. 
